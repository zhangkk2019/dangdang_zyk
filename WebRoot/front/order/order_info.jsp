	...
	<body>
		...
		<div class="fill_message">
			...
			<table class="tab_login">
				...
				<c:forEach items="${sessionScope.cart }" var="cart">
					<tr>
						...
						<td valign="top">
							${cart.value.book.name }
						</td>
						<td valign="top">
							${cart.value.book.dprice }
						</td>
						<td valign="top">
							${cart.value.count }
						</td>
						<td valign="top">
							${cart.value.book.dprice*cart.value.count }
						</td>
					</tr>
					</c:forEach>
				...
				<tr>
					<td valign="top" class="w1" style="text-align: left" colspan="5">
						<b>总价￥${sessionScope.totalMoney }</b>
					</td>
				</tr>
			</table>
			<br />
			...
			<div class="login_in">
				...
				<a href="${pageContext.request.contextPath }/address/selectAddress?id=${sessionScope.user.id}">
